...
///
/// 2、坐标转换
/// Offset newViewportPoint = _TEPhotoViewWidgetState.fromViewport(originalViewportPoint)
///
/// 3、用法
/// PageView.builder(
...
class TEPhotoViewWidget extends StatefulWidget {
  ...
  static _TEPhotoViewWidgetState of(BuildContext context, {bool root = false}) => root
      ? context.findRootAncestorStateOfType<_TEPhotoViewWidgetState>()
      : context.findAncestorStateOfType<_TEPhotoViewWidgetState>();
  ...
  @override
  _TEPhotoViewWidgetState createState() => _TEPhotoViewWidgetState();
}
...
class _TEPhotoViewWidgetState extends State<TEPhotoViewWidget> with TickerProviderStateMixin {
...
//  static Offset fromViewport(Offset viewportPoint, Matrix4 transform) {
  ...
  double get scaleValue => _transform.getMaxScaleOnAxis();
